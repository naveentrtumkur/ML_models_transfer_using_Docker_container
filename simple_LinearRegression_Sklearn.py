...
def prepare_data(csvFile_name, number):
    training_data = pd.read_csv(csvFile_name)
    ...
    test_data = training_data.head(50).values
    ...
    dRow = training_data.iloc[(number+50)::100].values
    #The first column is unnecessary, just drop it.
...
if __name__ == "__main__":
    ...
    prepare_data(csvFile_name,5) # Call teh prepare data function
    #find_accuracy() This will be called.
